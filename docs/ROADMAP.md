...
- [x] Broker Review v1 deployed: canonical ContentItem review page đọc verdict,
  analysis và FAQ từ ContentItem; identity/facts/offers từ Broker/BrokerFact/
  AffiliateLink; market assessment riêng qua BrokerReviewAssessment. Xem
  `openspec/changes/031-broker-review-v1/`.
