...
export function SiteHeader() {
    ...
    <div className="site-container header-inner">
      <Link href="/" className="wordmark" aria-label="Forex Journal home"><span className="brand-symbol" aria-hidden="true">F<span>↗</span></span>Forex<span className="brand-light">Journal</span></Link>
...
export function SiteFooter() {
    ...
    <div className="footer-top"><Link className="wordmark" href="/">Forex<span className="brand-light">Journal</span></Link><p>A clearer perspective on forex.</p><nav aria-label="Footer navigation"><Link href="/#education">Education</Link><Link href="/#guides">Guides</Link><Link href="/#brokers">Brokers</Link></nav></div>
